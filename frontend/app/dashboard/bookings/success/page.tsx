...
function InfoBox({ label, value, icon }: { label: string; value: string; icon: React.ReactNode }) {
  return (
    <div style={{ flex: 1, background: "#EEEEEE", borderRadius: 12, padding: "12px 14px", display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{
          ...
          <div style={{ padding: "1.5rem" }}>
            ...
            <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
              <InfoBox label="Check-in" value={fmtDate(booking.checkIn)} icon={
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke={BRAND_RED} strokeWidth="1.8">
                  <path d="M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4" /><polyline points="10 17 15 12 10 7" /><line x1="15" y1="12" x2="3" y2="12" />
                </svg>
              } />
              <InfoBox label="Check-out" value={fmtDate(booking.checkOut)} icon={
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke={BRAND_RED} strokeWidth="1.8">
                  <path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4" /><polyline points="16 17 21 12 16 7" /><line x1="21" y1="12" x2="9" y2="12" />
                </svg>
              } />
            ...
            <div style={{ display: "flex", gap: 10, marginBottom: "1.25rem" }}>
              <InfoBox label="Guests" value={`${booking.guests} guest${booking.guests > 1 ? "s" : ""}`} icon={
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke={BRAND_RED} strokeWidth="1.8">
