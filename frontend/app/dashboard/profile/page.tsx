...
export default function ProfilePage() {
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "3rem 5vw" }}>
      ...
      {/* Back link */}
      <Link href="/dashboard" style={{ fontSize: "0.8rem", color: "#aaa", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 5, marginBottom: "2rem" }}>
        ← Back to Dashboard
      </Link>

      {/* ── PROFILE UPDATE ── */}
      <div style={{ display: "grid", gridTemplateColumns: "200px 1fr", gap: "3rem", alignItems: "start", marginBottom: "4rem", paddingBottom: "4rem", borderBottom: "1px solid #f0f0f0" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
          ...
          >
            {imagePreview ? (
              ...
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2.5rem", color: "#C9A96E", fontWeight: 600 }}>
        ...
        {/* Form */}
        <div>
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2rem", fontWeight: 600, color: "#1a1a1a", marginBottom: "0.3rem" }}>
            Update Profile
          </h1>
          <p style={{ fontSize: "0.82rem", color: "#aaa", marginBottom: "1.5rem" }}>Keep your VillaBaas account details up to date.</p>
          ...
          <form onSubmit={handleProfileSubmit} noValidate>
            ...
            <button type="submit" disabled={profilePending} style={{
              ...
              fontSize: "0.875rem", fontWeight: 500, cursor: profilePending ? "not-allowed" : "pointer",
            }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "200px 1fr", gap: "3rem", alignItems: "start" }}>
        ...
        {/* Form */}
        <div>
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2rem", fontWeight: 600, color: "#1a1a1a", marginBottom: "0.3rem" }}>
            Change Password
          </h2>
          <p style={{ fontSize: "0.82rem", color: "#aaa", marginBottom: "1.5rem" }}>Choose a new password for your VillaBaas account.</p>
          ...
          <form onSubmit={handlePasswordSubmit} noValidate>
            <div style={{ marginBottom: "1rem" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                <button type="button" onClick={() => setShowPw(v => !v)} style={{ position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "#aaa" }}>
                  {showPw ? "🙈" : "👁"}
                </button>
              </div>
            ...
            <div style={{ marginBottom: "1rem" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                />
                <button type="button" onClick={() => setShowConfirm(v => !v)} style={{ position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "#aaa" }}>
                  {showConfirm ? "🙈" : "👁"}
                </button>
              </div>
            ...
            <button type="submit" disabled={pwPending} style={{
              height: 48, padding: "0 32px",
              background: pwPending ? "#999" : "#1A1A1A", color: "#fff",
              border: "none", borderRadius: 8, fontFamily: "'DM Sans', sans-serif",
              fontSize: "0.875rem", fontWeight: 500, cursor: pwPending ? "not-allowed" : "pointer",
            }}>
